...
\usepackage{hyperref}
\setlength{\parskip}{3.0pt plus 1.0pt minus 0.5pt}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.75\textwidth,height=7cm,keepaspectratio]{figures/bologna/bologna_optimized_layout.png}
...
To evaluate how these infrastructures absorb massive commuter congestion, we ran a forced passenger injection simulation at \textit{Stazione Centrale} and the \textit{Autostazione}, Bologna's main inter-modal hubs.

\begin{figure}[!htbp]
    \centering
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{figures/bologna/bologna_forced_injection_shock.png}
