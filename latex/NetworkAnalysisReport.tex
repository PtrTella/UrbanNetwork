...
The main contribution of this project is a data-driven, reproducible analysis pipeline for Bologna. It models traffic congestion via the Bureau of Public Roads (BPR) function, maps municipal population data onto the network, and simulates structural percolation.
...
\begin{itemize}
    ...
    \item \textbf{Dynamic Targeted Attacks}: In real-world failures, traffic dynamically redistributes. We therefore implemented a \textbf{dynamic (sequential) targeted attack} in which betweenness centrality is recalculated after every node removal~\cite{albert}, in addition to the static-ranking percolation analysis.
