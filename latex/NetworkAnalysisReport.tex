...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.45\textwidth,height=4.2cm,keepaspectratio]{figures/bologna/bologna_static_network.png}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_communities_map.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_bottlenecks_map.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_centrality_scatter.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_betweenness_hist.png}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_resilience_curves.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_demographic_pressure_map.png}
        \caption{Exogenous stress: demographic pressure density overlaid.}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_resilience_comparison.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{figures/bologna/bologna_optimized_layout.png}
        \caption{Optimal tramway layout designed by the greedy TNDP algorithm.}
...
% Comparative resilience comparison and optimal layout map are combined above with resilience curves and demographic pressure map
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.8cm,keepaspectratio]{figures/bologna/bologna_forced_injection_shock.png}
