...
from src.simulator import run_resilience_simulation, simulate_removal
...
print("\n  Generating centrality hotspots visualization...")
...
print(f"Erdos-Renyi Random Graph Null Model (LCC):")
...
print(f"1D Regular Lattice Null Model:")
...
print(f"{'Fraction %':<12}{'Rand LCC':<12}{'Target LCC':<12}{'Rand Frag':<12}{'Target Frag':<12}{'Rand Eff':<12}{'Target Eff':<12}")
...
print(f"Collapse visualization generated.")
print(f"  Removed nodes: {removed_nodes}")
print(f"  LCC size: {len(lcc_nodes)} nodes ({len(lcc_nodes)/N*100:.2f}% of original)")
